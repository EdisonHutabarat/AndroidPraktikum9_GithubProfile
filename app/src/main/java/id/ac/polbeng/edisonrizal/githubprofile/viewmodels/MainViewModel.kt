package id.ac.polbeng.edisonrizal.githubprofile.viewmodels
...
class MainViewModel : ViewModel(){
    ...
    fun searchUser(query: String){
        ...
        requestCall.enqueue(object : retrofit2.Callback<GithubUser> {
            override fun onResponse(call: Call<GithubUser>, response: retrofit2.Response<GithubUser>) { _isLoading.value = false
